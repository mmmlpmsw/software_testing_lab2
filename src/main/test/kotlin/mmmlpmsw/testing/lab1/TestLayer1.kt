...
class TestLayer1 {
    ...
    fun initMock() {
        ...
        Mockito.`when`(mock.tan(-3 * Math.PI / 4)).thenReturn(1.0)
        ...
        Mockito.`when`(mock.cot(-3 * Math.PI / 4)).thenReturn(1.0)
...
//--------------------------------------------------------------------------
        ...
        Mockito.`when`(mock.tan(-PERIOD + -3 * Math.PI / 4)).thenReturn(1.0)
        ...
        Mockito.`when`(mock.cot(-PERIOD + -3 * Math.PI / 4)).thenReturn(1.0)
...
//--------------------------------------------------------------------------
        ...
        Mockito.`when`(mock.tan(- 100 * PERIOD + -3 * Math.PI / 4)).thenReturn(1.0)
        ...
        Mockito.`when`(mock.cot(- 100 * PERIOD + -3 * Math.PI / 4)).thenReturn(1.0)
...
//===========================================================================================
    ...
    fun testOnMainPeriod() {
        ...
        assertEquals(0.0, calculator.calculate(-3 * Math.PI / 4), 1E-6)
